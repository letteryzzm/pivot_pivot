  ...
  [
    {
      ...
      choices: [
        ...
        { id: '1-1d', text: '把朋友也拉来一起聊，看看他们有没有同样的痛点', effects: { connection: 4, judgment: 4, action: 3, cognition: 1 }, clawReaction: '{name}把聚餐变成了用户调研。朋友觉得有趣，用户觉得轻松，一举两得。' },
      ],
    },
    {
      id: 1,
    ...
    },
    {
      ...
      choices: [
        ...
        { id: '1-3b', text: '报个课程系统学习', effects: { cognition: 3, action: 1, judgment: 1 }, clawReaction: '{name}花了一周看课程。学到了很多，但还没动手做。知道和做到之间隔着一万行代码。' },
  ...
  [
    ...
    },
    {
      ...
      choices: [
        ...
        { id: '2-2b', text: '有点沮丧，但那2个感兴趣的人给了我信心', effects: { judgment: 2, action: 1, cognition: 1, connection: 1 }, clawReaction: '{name}回家仔细回忆那两个人的表情。他们是真的需要，还是在礼貌地鼓励？' },
        { id: '2-2c', text: '不看态度，看行为——那2个人的反应才有意义', effects: { judgment: 5, cognition: 4, action: 2 }, clawReaction: '{name}开始懂了：用户会撒谎，但行为不会。那两个人追问了细节，这才是真信号。' },
  ...
  [
    ...
    },
    {
      ...
      choices: [
        ...
        { id: '3-3b', text: '砍功能，只留最核心的一个', effects: { judgment: 5, action: 4, cognition: 2 }, clawReaction: '{name}把功能列表从15项砍到了3项。突然发现，其实只有1项是用户真正需要的。' },
        { id: '3-3c', text: '通宵赶工，不管质量先做出来', effects: { action: 5, judgment: 1 }, clawReaction: '{name}连续三个通宵。做出来了，但自己都不太满意。不过——做出来，永远比完美更重要。' },
        { id: '3-3d', text: '不做产品了，先用手工方式帮5个用户解决问题', effects: { judgment: 5, action: 5, cognition: 3, connection: 2 }, clawReaction: '{name}放弃了产品思维，直接用微信+手工帮用户干活。效率低，但发现了产品永远发现不了的需求。' },
      ],
    },
  ],
  ...
  [
    {
      ...
      choices: [
        ...
        { id: '4-1d', text: '坐在用户旁边看他们用，比发出去更重要', effects: { judgment: 5, cognition: 4, connection: 3, action: 2 }, clawReaction: '{name}看到用户在第三步卡住了，皱着眉头。这一秒的观察，胜过一万字的产品文档。' },
      ],
    },
    {
      id: 4,
      ...
      choices: [
        ...
        { id: '4-2d', text: '跟实习公司谈：能不能远程或半职，同时做项目', effects: { judgment: 4, connection: 3, action: 3, cognition: 1 }, clawReaction: '{name}居然谈成了。对方说\'我们也想看看你那个项目\'。有时候最好的选择不是二选一。' },
      ],
    },
    {
      id: 4,
      ...
      choices: [
        ...
        { id: '4-3c', text: '认真谈一次，让他/她理解这件事对你有多重要', effects: { judgment: 4, connection: 3, action: 2, cognition: 1 }, clawReaction: '{name}第一次认真地跟对方讲了自己在做的事。对方沉默了一会儿，说\'那我能帮什么？\'' },
  ...
  [
    {
      ...
      choices: [
        ...
        { id: '5-1b', text: '讨论一下，找一个折中方案', effects: { connection: 2, judgment: 2, cognition: 1, action: 1 }, clawReaction: '{name}和他聊了两小时。最后决定先用微信群跑两周，如果数据好再做APP。折中但有效。' },
        { id: '5-1c', text: '坚持自己的，先验证需求比做产品更重要', effects: { judgment: 5, action: 4, cognition: 3, connection: -1 }, clawReaction: '{name}坚持了。合伙人不太高兴，但两周后数据出来了——{name}是对的。' },
        { id: '5-1d', text: '两个人各做一个方案，用数据说话', effects: { judgment: 4, action: 4, cognition: 3, connection: 1 }, clawReaction: '两周后，微信群方案拿到了20个真实用户，APP方案还在画原型。数据说话了。' },
      ],
    },
    {
      id: 5,
      ...
      choices: [
        ...
        { id: '5-2c', text: '不在意，他们不是我的用户', effects: { judgment: 4, action: 3, cognition: 2, connection: -1 }, clawReaction: '{name}开始明白一个道理：投资人看数据，用户看价值，长辈看风险。你不能用同一把尺子量所有人。' },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: '5-3b', text: '再投最后2000，如果还是不行就停', effects: { judgment: 3, action: 2, cognition: 2 }, clawReaction: '{name}给了自己最后一次机会。这2000块的使用效率，可能是你人生中最高的一次。' },
        { id: '5-3c', text: '想办法赚钱——做兼职也行，但不停项目', effects: { action: 5, judgment: 4, cognition: 1 }, clawReaction: '{name}白天送外卖，晚上做产品。辛苦，但项目没停。创业最怕的不是苦，是断裂。' },
        { id: '5-3d', text: '去找3个用户问：你愿意为这个付钱吗？答案决定下一步', effects: { judgment: 6, action: 4, cognition: 3, connection: 2 }, clawReaction: '{name}问了三个人。两个人犹豫，一个人说\'现在就可以付\'。这一个回答，比8000块的投入更有价值。' },
      ],
    },
  ],
  ...
  [
    {
      ...
      choices: [
        ...
        { id: '6-1c', text: '去用他们的产品，找到他们没做好的地方', effects: { judgment: 5, cognition: 5, action: 3 }, clawReaction: '{name}花了一整天体验竞品。发现了5个明显的缺陷。有竞品反而是好事——说明需求是真的。' },
        { id: '6-1d', text: '好事——说明需求是真的。我要做得更贴近用户', effects: { judgment: 5, action: 5, cognition: 3, connection: 1 }, clawReaction: '{name}的心态转变了。有人在做说明方向对了，做得更好说明市场够大。真正的壁垒是你对用户的理解深度。' },
      ],
    },
    {
      id: 6,
    ...
    },
    {
      ...
      choices: [
        { id: '6-3a', text: '立刻停下来休息，身体最重要', effects: { cognition: 1, connection: 1, action: -2 }, clawReaction: '{name}休息了一周。身体恢复了，但项目停了一周。健康是1，其他都是后面的0。' },
        { id: '6-3b', text: '减少到每天10小时，找到可持续的节奏', effects: { judgment: 4, action: 2, cognition: 2 }, clawReaction: '{name}找到了自己的可持续节奏。创业是马拉松不是百米冲刺，节奏比速度更重要。' },
        ...
        { id: '6-3d', text: '审视自己是不是在用\'忙\'逃避更难的问题', effects: { judgment: 5, cognition: 4, action: 1 }, clawReaction: '{name}停下来想了想：这14小时里，真正有价值的可能只有6小时。其余时间是在用忙碌麻痹自己。' },
      ],
    },
  ],
  ...
  [
    {
      ...
      choices: [
        ...
        { id: '7-1b', text: '可以短期接受，但会寻找改善办法', effects: { judgment: 3, action: 2, cognition: 1 }, clawReaction: '{name}住进了一个月租800的合租房。环境很差，但两个月后换了一个好一点的——因为产品开始赚钱了。' },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: '7-2c', text: '真正理解我的人不会这么说', effects: { judgment: 4, action: 3, cognition: 1, connection: -1 }, clawReaction: '{name}不再解释了。创业会重新筛选你的社交圈——留下来的才是真的。' },
        { id: '7-2d', text: '我的社交圈正在换——和做事的人在一起更有意义', effects: { judgment: 5, connection: 3, action: 3, cognition: 2 }, clawReaction: '{name}开始参加创业者聚会。发现和做事的人在一起，每一次对话都有密度。' },
      ],
    },
    {
      id: 7,
      ...
      choices: [
        ...
        { id: '7-3b', text: '投一半，留一半保底', effects: { judgment: 3, action: 2, cognition: 1 }, clawReaction: '{name}投了2万5。这个选择本身就说明了一件事——你信，但不是全信。' },
        { id: '7-3c', text: '全投，但要先确认最关键的假设', effects: { judgment: 5, action: 4, cognition: 3 }, clawReaction: '{name}在投钱之前做了一件事：找10个用户问了一个问题。答案让{name}确信这钱值得投。' },
  ...
  [
    {
      ...
      choices: [
        ...
        { id: '8-1b', text: '休学一年，给自己一个时间窗', effects: { judgment: 4, action: 3, cognition: 2 }, clawReaction: '{name}找了辅导员谈休学。一年的窗口期，足够验证一个方向。' },
        { id: '8-1c', text: '退学，把所有时间投入项目', effects: { action: 6, judgment: 3, connection: -1 }, clawReaction: '{name}退学了。家人很担心，但{name}从没这么清醒过。' },
        { id: '8-1d', text: '取决于项目数据——如果用户在增长就退，还在验证期就不退', effects: { judgment: 6, action: 4, cognition: 4 }, clawReaction: '{name}不冲动也不怯懦。让数据做决策，这是最成熟的创业者思维。' },
      ],
    },
    {
      id: 8,
      ...
      choices: [
        ...
        { id: '8-2c', text: '每次失败都让我离正确答案更近了', effects: { judgment: 5, cognition: 4, action: 3 }, clawReaction: '{name}列了一张表：三次失败分别教会了我什么。发现这张表比任何MBA课程都有价值。' },
    ...
    },
    {
      ...
      choices: [
        { id: '8-3a', text: '不借钱，有多少做多少', effects: { judgment: 2, action: -1, cognition: 1 }, clawReaction: '{name}选择了零杠杆。安全，但也意味着速度受限。' },
        { id: '8-3b', text: '找家人借，他们最安全', effects: { connection: 2, action: 2 }, clawReaction: '{name}开口了。家人虽然不理解，但还是支持了。不过这笔钱的重量，比银行贷款更重。' },
        { id: '8-3c', text: '找相信你的人投资，给他们股份', effects: { judgment: 4, connection: 4, action: 3, cognition: 1 }, clawReaction: '{name}写了一页纸的商业计划，找了3个相信自己的人。一个人投了5万，说\'我投的是你这个人\'。' },
        { id: '8-3d', text: '先想办法让项目自己赚钱，哪怕很少', effects: { judgment: 5, action: 5, cognition: 3 }, clawReaction: '{name}绞尽脑汁让产品产生了第一笔收入——虽然只有500块/月，但它证明了模式能跑通。' },
      ],
    },
  ],
  ...
  [
    {
      ...
      choices: [
        ...
        { id: '9-1b', text: '做一次试试效果，如果不舒服就停', effects: { action: 3 }, clawReaction: '{name}试了一次。效果确实好，但心里一直不舒服。有些线一旦越过，就很难回来。' },
        { id: '9-1c', text: '做，但给自己设一条底线', effects: { action: 3, judgment: 2, cognition: 1 }, clawReaction: '{name}在灰色地带找了一个平衡点。但底线这种东西，一旦开始后退，就会越退越远。' },
        { id: '9-1d', text: '不做——但找到一个比它更好的正路方法', effects: { judgment: 5, action: 4, cognition: 4, connection: 1 }, clawReaction: '{name}花了三倍时间找到了一个干净的增长方式。效果更慢，但可持续。真正的壁垒不是速度，是信任。' },
      ],
    },
    {
      id: 9,
      ...
      choices: [
        ...
        { id: '9-2b', text: '休息两周，边养病边远程处理最关键的事', effects: { judgment: 3, action: 2, cognition: 1 }, clawReaction: '{name}学会了区分\'重要\'和\'紧急\'。躺在床上也能做判断和决策，不能做的只是执行。' },
        { id: '9-2c', text: '找人暂时接手日常工作，自己只处理决策', effects: { judgment: 5, connection: 3, action: 2, cognition: 2 }, clawReaction: '{name}第一次真正授权。发现团队其实可以自己跑，只是之前你不敢放手。' },
        { id: '9-2d', text: '带病坚持', effects: { action: 4, judgment: -1, cognition: -2, connection: -1 }, clawReaction: '{name}撑过了那个月。但身体的账单最终还是要还的——只是不知道什么时候。' },
      ],
    },
    {
      id: 9,
      ...
      choices: [
        ...
        { id: '9-3c', text: '冷静分析：留下的人能不能继续？最核心的资产是什么？', effects: { judgment: 6, cognition: 4, action: 3 }, clawReaction: '{name}列了一张清单。代码可以重写，用户关系在自己手里。最核心的资产从来不是代码，是你对用户的理解。' },
  ...
  [
    {
      ...
      choices: [
        ...
        { id: '10-1b', text: '跟他们深谈一次，把真实数据和进展讲清楚', effects: { judgment: 4, connection: 4, action: 2, cognition: 2 }, clawReaction: '{name}准备了一份\'给爸妈看的PPT\'。用数据和逻辑，像对投资人一样认真。父母没完全理解，但态度软了。' },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: '10-2b', text: '把3万块和3个月全部投入那一个最关键的假设', effects: { judgment: 5, action: 5, cognition: 3 }, clawReaction: '{name}把所有资源聚焦到一个点上。三个月后，答案是明确的——不管是\'成了\'还是\'不成\'，至少知道了。' },
        ...
        { id: '10-2d', text: '去找10个用户说实话：你们愿不愿意现在就付钱？他们的回答决定一切', effects: { judgment: 6, action: 5, connection: 4, cognition: 3 }, clawReaction: '{name}没有猜测，没有假设，直接问了最残酷的问题。4个人说\'愿意\'。这4个人，就是{name}继续下去的全部理由。' },
      ],
    },
    {
      id: 10,
      ...
      choices: [
        ...
        { id: '10-3b', text: '因为我看到了一个机会', effects: { judgment: 3, action: 2, cognition: 2 }, clawReaction: '{name}看到了别人没看到的东西。能看到机会是天赋，抓住机会是选择。' },
        { id: '10-3c', text: '因为有一群人真的需要它，而我能做出来', effects: { judgment: 5, action: 4, cognition: 3, connection: 3 }, clawReaction: '{name}的回答不是关于自己，而是关于用户。这才是创业最坚实的理由——有人需要，你能做。' },
