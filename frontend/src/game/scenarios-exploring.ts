  ...
  [
    {
      ...
      choices: [
        ...
        { id: '1-1b', text: '去一个没去过的地方逛逛，哪怕只是隔壁区', effects: { cognition: 2, action: 3, judgment: 1, connection: 1 }, clawReaction: '{name}在一条从没走过的街上发现了一家很酷的小店，和老板聊了半小时。' },
        { id: '1-1c', text: '找几个有意思的人约出来聊天', effects: { connection: 4, cognition: 1, judgment: 1, action: 3 }, clawReaction: '{name}约了三个不同领域的朋友，一顿饭聊出了好几个新想法。' },
        { id: '1-1d', text: '打开电脑研究一个最近感兴趣的方向', effects: { cognition: 3, action: 4, judgment: 1 }, clawReaction: '{name}一抬头已经凌晨两点了，浏览器开了47个标签页。' },
      ],
    },
    {
      id: 1,
      ...
      choices: [
        ...
        { id: '1-2c', text: '直接找做事情的人聊，听第一手经验', effects: { connection: 4, judgment: 1, cognition: 1, action: 5 }, clawReaction: '{name}上周跟一个创业的学长聊了两小时，比看十篇文章收获都大。' },
        { id: '1-2d', text: '去翻原始数据、论文、产品官网，自己判断', effects: { cognition: 3, judgment: 3, action: 5 }, clawReaction: '{name}养成了一个习惯：看到任何观点，先找数据源。' },
      ],
    },
    {
      id: 1,
      ...
      choices: [
        ...
        { id: '1-3c', text: '提出一个不同角度，哪怕会冷场', effects: { judgment: 3, cognition: 2, connection: -1, action: 4 }, clawReaction: '桌上安静了三秒。然后有人说\'你说的有道理\'，讨论变得真正有意思起来。' },
        { id: '1-3d', text: '不争论，但回家会自己查资料验证', effects: { cognition: 3, judgment: 2, action: 4 }, clawReaction: '{name}当晚查了两小时资料，发现饭桌上大家说的有一半是错的。' },
      ],
    },
  ],
  ...
  [
    {
      ...
      choices: [
        ...
        { id: '2-1d', text: '这个和我在想的那个事情是不是有关联？', effects: { judgment: 3, cognition: 3, connection: 1, action: 5 }, clawReaction: '{name}在脑子里建立了一个新的连接。这种时刻，比考满分还让人兴奋。' },
      ],
    },
    {
      id: 2,
      ...
      choices: [
        ...
        { id: '2-2c', text: '自己对这个方向产生了好奇，停不下来', effects: { cognition: 3, judgment: 2, action: 4 }, clawReaction: '{name}上次为了搞懂一个问题连饭都忘了吃，这种状态才是真正的学习。' },
        { id: '2-2d', text: '因为要解决一个真实问题，必须学会', effects: { action: 5, judgment: 3, cognition: 2, connection: 1 }, clawReaction: '{name}发现当学习有了具体目标，效率是平时的十倍。' },
      ],
    },
    {
      id: 2,
      ...
      choices: [
        ...
        { id: '2-3b', text: '去旅行，看看不同的世界', effects: { cognition: 2, connection: 1, judgment: 1, action: 3 }, clawReaction: '{name}在另一个城市走了三天，发现那里的人用完全不同的方式解决同样的问题。' },
        { id: '2-3c', text: '请几个厉害的人吃饭，听他们聊', effects: { connection: 4, cognition: 1, judgment: 2, action: 3 }, clawReaction: '{name}花了三千块请了五个人吃饭，拿到的信息价值三十万。' },
        { id: '2-3d', text: '拿去做一个小实验，验证一个想法', effects: { action: 5, judgment: 2, cognition: 2 }, clawReaction: '{name}买了域名、服务器和一些工具。一万块不多，但够点燃一个实验。' },
      ],
    },
  ],
  ...
  [
    {
      ...
      choices: [
        ...
        { id: '3-1c', text: '反而更来劲了——那就做给你看', effects: { action: 5, judgment: 3, connection: -1 }, clawReaction: '{name}把这句话截图保存了。将来成功了要发给他看。' },
        { id: '3-1d', text: '认真想想他说的有没有道理，但不会因此放弃', effects: { judgment: 3, cognition: 2, action: 5, connection: 1 }, clawReaction: '{name}复盘了一下，确实有些想法不靠谱。但不靠谱和不现实是两码事。' },
      ],
    },
    {
      id: 3,
      ...
      choices: [
        ...
        { id: '3-2c', text: '仔细复盘了哪里出了问题', effects: { cognition: 2, judgment: 3, action: 5 }, clawReaction: '{name}写了一页复盘笔记。失败不可怕，不复盘才可怕。' },
        { id: '3-2d', text: '复盘之后立刻做了一个新的尝试', effects: { action: 5, judgment: 3, cognition: 2 }, clawReaction: '{name}发现失败后最好的解药不是休息，而是立刻重新出发。' },
      ],
    },
    {
      id: 3,
      ...
      choices: [
        ...
        { id: '3-3c', text: '想办法绕过它，找到合规的替代方案', effects: { judgment: 3, action: 4, cognition: 2 }, clawReaction: '{name}找到了一个既不违反规定又能达到目的的方法。创业者的基因就是不接受\'不行\'。' },
  ...
  [
    {
      ...
      choices: [
        ...
        { id: '4-1c', text: '白手起家、从零做出成绩的人', effects: { action: 4, judgment: 2, cognition: 1 }, clawReaction: '{name}每次听到这样的故事都热血沸腾，但也会问自己：我能吗？' },
        { id: '4-1d', text: '看到问题就忍不住去解决、想改变世界的人', effects: { judgment: 3, action: 5, cognition: 2, connection: 1 }, clawReaction: '{name}最近开始觉得，\'改变世界\'也许不是口号，而是一种生活方式。' },
      ],
    },
    {
      id: 4,
      ...
      choices: [
        ...
        { id: '4-2c', text: '在做一件自己发起的事，有一群人跟着你', effects: { judgment: 2, action: 4, connection: 2, cognition: 1 }, clawReaction: '{name}看到了一间办公室，墙上贴满了便签和数据。那种画面让心跳加速。' },
        { id: '4-2d', text: '说不清，但一定不是现在这样——要有自己的路', effects: { judgment: 2, action: 5, cognition: 2 }, clawReaction: '{name}唯一确定的是：不想过一个可以被预测的人生。' },
      ],
    },
    {
      id: 4,
      ...
      choices: [
        ...
        { id: '4-3c', text: '掌握自己未来的方向', effects: { judgment: 3, cognition: 2, action: 4 }, clawReaction: '{name}厌倦了被安排。不管方向对不对，至少要是自己选的。' },
  ...
  [
    {
      ...
      choices: [
        ...
        { id: '5-1c', text: '每天重复一样的事，没有成长', effects: { cognition: 1, judgment: 2, action: 4 }, clawReaction: '{name}一想到十年后还在做同样的事，就有一种窒息感。' },
        { id: '5-1d', text: '明明看到了问题却什么都做不了', effects: { judgment: 4, action: -1, cognition: 5 }, clawReaction: '{name}最痛苦的不是失败，而是旁观。' },
      ],
    },
    {
      id: 5,
      ...
      choices: [
        ...
        { id: '5-2c', text: '有点羡慕，开始认真想自己是不是也可以', effects: { judgment: 2, cognition: 1, action: 4 }, clawReaction: '{name}那天晚上失眠了。不是焦虑，而是心里有什么东西被点燃了。' },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: '5-3b', text: '选自己最感兴趣的，管它好不好找工作', effects: { judgment: 2, cognition: 1, action: 4 }, clawReaction: '{name}选了那个让自己眼睛发亮的方向。事实上，热情本身就是最大的竞争力。' },
  ...
  [
    {
      ...
      choices: [
        ...
        { id: '6-1b', text: '自由，不用看别人脸色', effects: { judgment: 2, action: 3, cognition: 1 }, clawReaction: '{name}追求的不是富有，而是不被束缚。' },
        { id: '6-1c', text: '工具，用来做更大的事', effects: { judgment: 3, action: 4, cognition: 2 }, clawReaction: '{name}开始把钱当作杠杆而不是目的。这是创业者思维的起点。' },
        { id: '6-1d', text: '结果，做对了事情自然会来', effects: { judgment: 3, cognition: 2, action: 5, connection: 1 }, clawReaction: '{name}不追钱，追价值。钱是价值的影子。' },
      ],
    },
    {
      id: 6,
      ...
      choices: [
        ...
        { id: '6-2c', text: '会做完全一样的事，我不是做给别人看的', effects: { judgment: 3, action: 5, cognition: 2 }, clawReaction: '{name}的驱动力来自内心。这种人不需要观众也能上场。' },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: '6-3c', text: '很难接受，总觉得自己可以做更多', effects: { judgment: 2, action: 5, cognition: 2 }, clawReaction: '{name}不是不满现状，而是不甘平庸。这种不甘心，是所有伟大故事的起点。' },
        { id: '6-3d', text: '完全不能接受——哪怕失败也要试过', effects: { action: -1, judgment: 4, cognition: 5, connection: -1 }, clawReaction: '{name}宁愿轰轰烈烈地输，也不愿平平淡淡地过。这是一种危险的特质，也是一种珍贵的特质。' },
      ],
    },
  ],
  ...
  [
    {
      ...
      choices: [
        ...
        { id: '7-1c', text: '跟他们认真谈一次，说服他们', effects: { judgment: 2, connection: 3, action: 3, cognition: 1 }, clawReaction: '{name}准备了一个小时的\'presentation\'给爸妈看。他们没被说服，但眼神里多了一些复杂的东西。' },
        { id: '7-1d', text: '尊重但不妥协，用结果证明自己', effects: { judgment: 5, action: -1, cognition: 4 }, clawReaction: '{name}不再争辩了。能说服父母的只有结果，不是道理。' },
      ],
    },
    {
      id: 7,
      ...
      choices: [
        ...
        { id: '7-2c', text: '可以，只要我自己知道方向是对的', effects: { judgment: 2, action: 5, cognition: 2, connection: -1 }, clawReaction: '{name}准备好了独行。在没有掌声的路上，你只能相信自己的判断。' },
        { id: '7-2d', text: '我现在就是这种状态', effects: { judgment: 4, action: 6, cognition: 2, connection: -1 }, clawReaction: '{name}已经习惯了不被理解。真正有结构外生长力的人，往往都在最孤独的时刻成长最快。' },
      ],
    },
    {
      id: 7,
      ...
      choices: [
        ...
        { id: '7-3c', text: '浑浑噩噩过完一辈子，什么都没留下', effects: { judgment: 3, action: 5, cognition: 2 }, clawReaction: '{name}最恐惧的是虚度。这种恐惧本身，就是一种驱动力。' },
        { id: '7-3d', text: '明明有能力改变一些事，却因为胆怯而没有做', effects: { judgment: 4, action: 6, cognition: 2 }, clawReaction: '{name}怕的是自己不够勇敢。好消息是——能意识到这一点的人，通常比自己以为的勇敢。' },
      ],
    },
  ],
  ...
  [
    {
      ...
      choices: [
        { id: '8-1a', text: '不赌，现在的生活已经还行了', effects: { action: 4, connection: 0 }, clawReaction: '{name}选择了确定性。但\'还行\'的生活，也意味着\'不会更好\'。' },
        { id: '8-1b', text: '要看具体是什么机会', effects: { judgment: 3, cognition: 2 }, clawReaction: '{name}不盲目冒险。好创业者不是赌徒——他们是风险管理者。' },
        { id: '8-1c', text: '赌，但会想办法把失败的代价降到最低', effects: { judgment: 3, action: 5, cognition: 3 }, clawReaction: '{name}不赌命，赌策略。把大风险拆小，一步步推进，这才是真正的创业思维。' },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: '8-2c', text: '不在意，每个人有自己的时间表', effects: { judgment: 2, cognition: 2, action: 4 }, clawReaction: '{name}不跟别人比进度。巴菲特99%的财富来自60岁之后——时间表从来不是线性的。' },
        { id: '8-2d', text: '反而更坚定了——越多人选那条路，机会就越不在那里', effects: { judgment: 4, action: 6, cognition: 2 }, clawReaction: '{name}在别人扎堆的地方看到了拥挤，在没人走的路上看到了机会。' },
      ],
    },
    {
      id: 8,
      ...
      choices: [
        ...
        { id: '8-3c', text: '不跟他们争，默默去找数据和案例验证', effects: { judgment: 3, cognition: 4, action: 6 }, clawReaction: '{name}不用嘴巴反驳，用事实说话。创业者的底层能力之一就是——在质疑中保持冷静。' },
  ...
  [
    ...
    },
    {
      ...
      choices: [
        ...
        { id: '9-2c', text: '回到起点重新开始——可以接受', effects: { judgment: 2, action: 4, cognition: 2 }, clawReaction: '{name}算了一笔账：最坏就是回到起点。而起点，也不是什么可怕的地方。' },
        { id: '9-2d', text: '最坏也就是得到了一次真实的成长——完全能接受', effects: { judgment: 3, action: 6, cognition: 4 }, clawReaction: '{name}把失败重新定义了——不是终点，而是学费。第一次创业最值钱的资产，是判断力的形成。' },
      ],
    },
    {
      id: 9,
      ...
      choices: [
        ...
        { id: '9-3c', text: '一个反复出现的想法——如果能把某件事做出来就好了', effects: { judgment: 3, cognition: 2, action: 5 }, clawReaction: '{name}脑子里有一颗种子，它一直在那里。反复出现的想法，值得被认真对待。' },
        { id: '9-3d', text: '对世界为什么是这样运转的思考', effects: { cognition: 3, judgment: 3, action: 6 }, clawReaction: '{name}在想本质的问题。这种人要么成为学者，要么成为创业者——两者都在用不同方式理解世界。' },
      ],
    },
  ],
  ...
  [
    {
      ...
      choices: [
        ...
        { id: '10-1b', text: '把想学的东西都学一遍', effects: { cognition: 2, action: 3, judgment: 1 }, clawReaction: '{name}选择了知识。但知识不被使用，就只是信息。' },
        { id: '10-1c', text: '去做那件一直想做但不敢做的事', effects: { action: 6, judgment: 4, cognition: 2 }, clawReaction: '{name}终于给了自己许可。但为什么要等到\'只剩5年\'才给？' },
        { id: '10-1d', text: '创造一个东西，让它在我走后还能帮助别人', effects: { judgment: 4, action: 6, cognition: 2, connection: 3 }, clawReaction: '{name}想要的不只是活过，而是存在过。创业，本质上就是创造比你活得更久的东西。' },
      ],
    },
    {
      id: 10,
      ...
      choices: [
        ...
        { id: '10-2d', text: '一个还在形成中的人——但方向越来越清晰了', effects: { judgment: 3, cognition: 4, action: 6, connection: 1 }, clawReaction: '{name}还没定型，但正在成型。这恰恰是最有潜力的状态——刀还没拔出来，但已经在发热。' },
      ],
    },
    {
      id: 10,
      ...
      choices: [
        ...
        { id: '10-3b', text: '我不确定，但我愿意试试', effects: { action: 4, judgment: 1, cognition: 1, connection: 1 }, clawReaction: '{name}迈出了第一步。不确定但愿意开始——这本身就是一种勇气。' },
        ...
        { id: '10-3d', text: '我早就在路上了，只是还没人注意到', effects: { judgment: 4, action: 6, cognition: 3 }, clawReaction: '{name}笑了。那种笑容背后，是早已开始的探索、沉默的努力、和一颗不需要掌声的心。' },
      ],
    },
  ],
]
