...
export const reflectionDialogImages = [
  ...
  { id: 6, path: '/images/背景/深色反思背景3.png', name: '深色反思3' },
  { id: 7, path: '/images/背景/深色反思背景4.png', name: '深色反思4' },
...
export const reflectionDeepImages = [
  ...
  { id: 15, path: '/images/背景/深色反思背景5.png', name: '深色反思5' },
  { id: 16, path: '/images/背景/深色反思背景6.png', name: '深色反思6' },
  { id: 17, path: '/images/背景/深色反思背景7.png', name: '深色反思7' },
  { id: 18, path: '/images/背景/深色反思背景8.png', name: '深色反思8' },
